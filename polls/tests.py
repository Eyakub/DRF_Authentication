...
"""
APIRequestFactory - this is similar to Django's RequestFactory. It allow
you to create requests with any http method, which you can then pass on to 
any view method and compare response

APIClient - similar to Djagno's Client. You can GET or POST a URL, and test responses

APITestCase - similar to Djagno's TestCase. Most of your tests will subclass this
"""
